            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                  ...
                  {(product.name === "just25" || product.appStoreUrl) && (
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        window.open(product.appStoreUrl || product.url, '_blank');
                      }}
                      className="bg-black text-white text-xs px-3 py-2 rounded-lg flex items-center gap-2 border border-gray-600 hover:bg-gray-900 transition cursor-pointer"
                    >
